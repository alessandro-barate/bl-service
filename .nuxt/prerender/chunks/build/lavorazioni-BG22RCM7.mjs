    ...
    const details = [
      {
        ...
        paragraphs: [
          "BL Service offre un servizio di riparazione completo per macchinari di lavorazione meccanica. I nostri tecnici specializzati intervengono con rapidit\xE0 e precisione per garantire la continuit\xE0 operativa della vostra produzione.",
      ...
      },
      {
        ...
        paragraphs: [
          "BL Service dispone di un ampio magazzino ricambi originali per garantire interventi rapidi ed efficaci. Forniamo componenti di qualit\xE0 certificata per assicurare le massime prestazioni dei vostri macchinari.",
...
export { lavorazioni as default };
//# sourceMappingURL=lavorazioni-BG22RCM7.mjs.map
