import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { toRef, isRef, hasInjectionContext, getCurrentInstance, inject, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, withCtx, getCurrentScope, nextTick, isReadonly, useSSRContext, isShallow, isReactive, toRaw } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrInterpolate } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B_sXBN0O.mjs')
  },
  {
    name: "servizi",
    path: "/servizi",
    component: () => import('./servizi-DAxAvRMQ.mjs')
  },
  {
    name: "contatti",
    path: "/contatti",
    component: () => import('./contatti-DQtQRTkt.mjs')
  },
  {
    name: "lavorazioni",
    path: "/lavorazioni",
    component: () => import('./lavorazioni-BG22RCM7.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D-BAGdsm.mjs').then((m) => m.default || m))
};
...
const usePageTransition = () => {
  ...
  const navigateWithTransition = async (path, customText) => {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isTransitioning)) {
        _push(`<div class="page-transition-overlay"><h1 class="page-transition-text">${ssrInterpolate(unref(transitionText))}</h1></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CyqNe5MD.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BvBcO590.mjs'));
...
export { usePageTransition as a, useState as b, useRouter as c, useNuxtApp as d, entry_default as default, encodeRoutePath as e, useRuntimeConfig as f, nuxtLinkDefaults as g, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };
