...
import { computed, ref, mergeProps, unref, useSSRContext, defineComponent, createElementBlock, shallowRef, getCurrentInstance, provide, cloneVNode, h, withCtx, createTextVNode } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrRenderSlot, ssrRenderAttr, ssrRenderStyle, ssrRenderTeleport, ssrRenderList, ssrInterpolate } from 'file://C:/Users/utente/Desktop/Miei%20Progetti/BL%20Service/bl-service/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { u as useRoute, a as usePageTransition, b as useState } from './server.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-DsTGTj6K.mjs';
...
const _imports_0$2 = "" + buildAssetsURL("bl-logo-bianco.CdAZarnH.svg");
const _sfc_main$4 = {
  __name: "Preloader",
...
const _imports_0$1 = "" + buildAssetsURL("LogoColore2.BJH5HytW.svg");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(showPrivacyPanel)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "privacy-overlay" }, _attrs))} data-v-e1c00dda><div class="privacy-panel" data-v-e1c00dda><button class="privacy-panel__close" data-v-e1c00dda> \u2715 </button><h3 class="privacy-panel__title uppercase" data-v-e1c00dda> informativa sulla privacy </h3><div class="privacy-panel__content" data-v-e1c00dda><p class="last-update" data-v-e1c00dda><em data-v-e1c00dda>Ultimo aggiornamento: <strong data-v-e1c00dda><span class="highlight" data-v-e1c00dda>[DATA DA INSERIRE]</span></strong></em></p><h3 class="uppercase" data-v-e1c00dda>1. titolare del trattamento</h3><p data-v-e1c00dda>Il Titolare del trattamento dei dati personali \xE8:</p><ul data-v-e1c00dda><li data-v-e1c00dda><strong data-v-e1c00dda>Ragione Sociale:</strong><span class="highlight" data-v-e1c00dda>[RAGIONE SOCIALE COMPLETA BL SERVICE]</span></li><li data-v-e1c00dda><strong data-v-e1c00dda>Sede Legale:</strong><span class="highlight" data-v-e1c00dda>[INDIRIZZO COMPLETO]</span></li><li data-v-e1c00dda><strong data-v-e1c00dda>Partita IVA:</strong><span class="highlight" data-v-e1c00dda>[P.IVA]</span></li><li data-v-e1c00dda><strong data-v-e1c00dda>Email:</strong><span class="highlight" data-v-e1c00dda>[EMAIL CONTATTO]</span></li><li data-v-e1c00dda><strong data-v-e1c00dda>Telefono:</strong><span class="highlight" data-v-e1c00dda>[TELEFONO]</span></li></ul><h3 class="uppercase" data-v-e1c00dda>2. tipologie di dati raccolti</h3><h4 data-v-e1c00dda>2.1 Dati forniti volontariamente dall&#39;utente</h4><p data-v-e1c00dda> Attraverso il modulo di contatto presente sul sito, l&#39;utente pu\xF2 fornire volontariamente i seguenti dati personali: </p><ul data-v-e1c00dda><li data-v-e1c00dda>Nome e cognome</li><li data-v-e1c00dda>Indirizzo email</li><li data-v-e1c00dda>Numero di telefono (se fornito)</li><li data-v-e1c00dda>Messaggio/richiesta</li><li data-v-e1c00dda>Eventuale azienda di appartenenza (se fornita)</li></ul><h4 data-v-e1c00dda>2.2 Cookie tecnici</h4><p data-v-e1c00dda> Il sito utilizza esclusivamente <strong data-v-e1c00dda>cookie tecnici</strong> strettamente necessari al funzionamento del sito stesso e alla navigazione. Questi cookie non richiedono il consenso dell&#39;utente in quanto indispensabili per fornire il servizio richiesto. </p><div class="note" data-v-e1c00dda><strong data-v-e1c00dda>Nota:</strong> Il sito non utilizza cookie di profilazione, cookie analitici o cookie di terze parti per finalit\xE0 di marketing o tracciamento. </div><h3 class="uppercase" data-v-e1c00dda> 3. finalit\xE0 del trattamento e base giuridica </h3><h4 data-v-e1c00dda>3.1 Dati del modulo di contatto</h4><p data-v-e1c00dda><strong data-v-e1c00dda>Finalit\xE0:</strong></p><ul data-v-e1c00dda><li data-v-e1c00dda> Rispondere alle richieste di informazioni inviate tramite il modulo di contatto </li><li data-v-e1c00dda> Fornire preventivi e informazioni sui servizi di lavorazione meccanica </li><li data-v-e1c00dda>Gestire la relazione con potenziali clienti</li></ul><p data-v-e1c00dda><strong data-v-e1c00dda>Base giuridica:</strong> Il trattamento \xE8 basato sul <strong data-v-e1c00dda>consenso esplicito dell&#39;interessato</strong> (Art. 6, par. 1, lett. a) del GDPR), manifestato al momento dell&#39;invio del modulo di contatto. </p><h4 data-v-e1c00dda>3.2 Cookie tecnici</h4><p data-v-e1c00dda><strong data-v-e1c00dda>Finalit\xE0:</strong> Garantire il corretto funzionamento del sito web e la navigazione dell&#39;utente. </p><p data-v-e1c00dda><strong data-v-e1c00dda>Base giuridica:</strong><strong data-v-e1c00dda>Legittimo interesse</strong> del Titolare (Art. 6, par. 1, lett. f) del GDPR), in quanto strettamente necessari per l&#39;erogazione del servizio richiesto dall&#39;utente. </p><h3 class="uppercase" data-v-e1c00dda>4. modalit\xE0 del trattamento</h3><p data-v-e1c00dda> I dati personali sono trattati con strumenti informatici e/o telematici, con modalit\xE0 organizzative e con logiche strettamente correlate alle finalit\xE0 indicate. I dati sono protetti mediante: </p><ul data-v-e1c00dda><li data-v-e1c00dda>Misure di sicurezza tecniche e organizzative adeguate</li><li data-v-e1c00dda>Accesso limitato ai soli soggetti autorizzati</li><li data-v-e1c00dda>Protocollo HTTPS per la trasmissione sicura dei dati</li></ul><h3 class="uppercase" data-v-e1c00dda>5. comunicazione e diffusione dei dati</h3><p data-v-e1c00dda>I dati personali raccolti potranno essere comunicati a:</p><ul data-v-e1c00dda><li data-v-e1c00dda><strong data-v-e1c00dda>Provider di hosting:</strong><span class="highlight" data-v-e1c00dda>[NOME PROVIDER]</span> per la gestione tecnica del sito web </li><li data-v-e1c00dda><strong data-v-e1c00dda>Servizio email:</strong><span class="highlight" data-v-e1c00dda>[ES: SERVIZIO SMTP/EMAIL UTILIZZATO]</span> per l&#39;invio e ricezione delle comunicazioni dal modulo di contatto </li></ul><p data-v-e1c00dda> I dati non saranno diffusi a terzi n\xE9 trasferiti all&#39;estero senza un&#39;adeguata base giuridica. </p><h3 class="uppercase" data-v-e1c00dda>6. periodo di conservazione</h3><p data-v-e1c00dda> I dati personali raccolti tramite il modulo di contatto saranno conservati per il tempo necessario a gestire la richiesta e comunque: </p><ul data-v-e1c00dda><li data-v-e1c00dda><strong data-v-e1c00dda>2 anni dall&#39;ultimo contatto</strong> con l&#39;interessato, salvo diversa richiesta di cancellazione </li><li data-v-e1c00dda> Per il tempo necessario ad adempiere eventuali obblighi di legge (es. conservazione documentale fiscale) </li></ul><p data-v-e1c00dda> I cookie tecnici hanno una durata limitata alla sessione di navigazione o comunque non superiore a quanto strettamente necessario. </p><h3 class="uppercase" data-v-e1c00dda>7. diritti dell&#39;interessato</h3><p data-v-e1c00dda>Ai sensi degli articoli 15-22 del GDPR, l&#39;utente ha diritto di:</p><ul data-v-e1c00dda><li data-v-e1c00dda><strong data-v-e1c00dda>Accesso</strong> (Art. 15): ottenere conferma dell&#39;esistenza dei propri dati e riceverne copia </li><li data-v-e1c00dda><strong data-v-e1c00dda>Rettifica</strong> (Art. 16): correggere dati inesatti o incompleti </li><li data-v-e1c00dda><strong data-v-e1c00dda>Cancellazione</strong> (Art. 17): ottenere la cancellazione dei dati (&quot;diritto all&#39;oblio&quot;) </li><li data-v-e1c00dda><strong data-v-e1c00dda>Limitazione</strong> (Art. 18): limitare il trattamento in casi specifici </li><li data-v-e1c00dda><strong data-v-e1c00dda>Portabilit\xE0</strong> (Art. 20): ricevere i dati in formato strutturato e leggibile </li><li data-v-e1c00dda><strong data-v-e1c00dda>Opposizione</strong> (Art. 21): opporsi al trattamento per motivi legittimi </li><li data-v-e1c00dda><strong data-v-e1c00dda>Revoca del consenso</strong>: revocare in qualsiasi momento il consenso prestato, senza pregiudicare la liceit\xE0 del trattamento basata sul consenso prima della revoca </li><li data-v-e1c00dda><strong data-v-e1c00dda>Reclamo</strong>: presentare reclamo all&#39;Autorit\xE0 Garante per la Protezione dei Dati Personali (<a href="https://www.garanteprivacy.it" target="_blank" data-v-e1c00dda>www.garanteprivacy.it</a>) </li></ul><p data-v-e1c00dda> Per esercitare i suddetti diritti, \xE8 possibile contattare il Titolare del trattamento agli indirizzi indicati al punto 1. </p><h3 class="uppercase" data-v-e1c00dda>8. modifiche alla privacy policy</h3><p data-v-e1c00dda> Il Titolare si riserva il diritto di modificare o aggiornare questa informativa in qualsiasi momento. Le modifiche saranno pubblicate su questa pagina con l&#39;indicazione della data di ultimo aggiornamento. </p><h3 class="uppercase" data-v-e1c00dda>9. informazioni sui cookie tecnici</h3><p data-v-e1c00dda> Questo sito utilizza esclusivamente <strong data-v-e1c00dda>cookie tecnici</strong>, che sono necessari per il funzionamento del sito e per consentire la navigazione. Questi cookie non raccolgono informazioni personali utilizzabili per scopi di marketing e non richiedono il consenso dell&#39;utente. </p><p data-v-e1c00dda><strong data-v-e1c00dda>Tipologie di cookie tecnici utilizzati:</strong></p><ul data-v-e1c00dda><li data-v-e1c00dda><strong data-v-e1c00dda>Cookie di navigazione/sessione:</strong> permettono la normale navigazione e utilizzo del sito web </li><li data-v-e1c00dda><strong data-v-e1c00dda>Cookie funzionali:</strong> memorizzano preferenze dell&#39;utente (es. lingua selezionata) per migliorare l&#39;esperienza di navigazione </li></ul><div class="note" data-v-e1c00dda><p data-v-e1c00dda><strong data-v-e1c00dda>Gestione dei cookie:</strong> L&#39;utente pu\xF2 gestire o disabilitare i cookie attraverso le impostazioni del proprio browser. Si ricorda che la disabilitazione dei cookie tecnici potrebbe compromettere la corretta fruizione di alcune funzionalit\xE0 del sito. </p></div><hr data-v-e1c00dda><p class="footer-text" data-v-e1c00dda> Per qualsiasi domanda relativa alla presente informativa, contattare: <strong data-v-e1c00dda><span class="highlight" data-v-e1c00dda>[EMAIL PRIVACY]</span></strong> o utilizzare il `);
        _push(ssrRenderComponent(_component_NuxtLink, { to: "/contatti" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`modulo di contatto`);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const onPreloaderComplete = () => {
      var _a;
      if ((_a = headerRef.value) == null ? void 0 : _a.showHeader) {
...
//# sourceMappingURL=default-D-BAGdsm.mjs.map
